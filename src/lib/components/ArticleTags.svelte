<script>
  ...
  export let tags = [];
  export let maxTags = 5; // Maksimum jumlah tag yang akan dipaparkan
  
  // Tapis tag yang akan dipaparkan
  ...
  // Fungsi untuk mendapatkan warna rawak berdasarkan nama tag
  function getTagColor(tagName) {
    // Jana hash dari nama tag untuk konsistensi warna
    let hash = 0;
