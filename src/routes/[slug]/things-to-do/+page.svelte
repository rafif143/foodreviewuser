...
<main class="bg-gradient-to-br from-gray-50 via-white to-red-50">
  ...
  <!-- Page Header -->
  <PageHeader 
    title="Artikel Aktivitas"
    description="Temukan aktivitas menarik dan tempat wisata terbaik di Kelantan untuk pengalaman liburan yang tak terlupakan"
    icon="book"
    compact={true}
  />
  ...
  <section class="py-8 bg-gradient-to-r from-red-50 to-orange-50">
    <div class="container mx-auto px-4">
      <div class="max-w-2xl mx-auto text-center">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Cari Artikel Aktivitas</h2>
        <p class="text-gray-600 mb-6">Temukan artikel, aktivitas, dan tempat wisata kegemaran anda</p>
          ...
          <form on:submit|preventDefault={() => handleSearch()}>
            <div class="relative">
              <input
                ...
                placeholder="Cari artikel aktivitas, tempat wisata, atau petualangan..."
