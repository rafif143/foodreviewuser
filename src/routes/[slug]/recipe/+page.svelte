  ...
  <section class="py-8 bg-gradient-to-r from-red-50 to-orange-50">
    <div class="container mx-auto px-4">
      <div class="max-w-2xl mx-auto text-center">
        <h2 class="text-2xl font-bold text-gray-800 mb-4">Cari Resep Masakan</h2>
        <p class="text-gray-600 mb-6">Temukan resep, tips memasak, dan panduan kuliner favorit Anda</p>
          ...
          <form on:submit|preventDefault={() => handleSearch()}>
            <div class="relative">
              <input
                ...
                placeholder="Cari resep, bahan, atau teknik memasak..."
